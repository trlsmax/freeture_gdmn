...
Fits2D::Fits2D(string path, std::shared_ptr<spdlog::logger> logger) : mFitsPath(path), mLogger(logger)
{
    kPROGRAM = "FreeTure";
    kCREATOR = "";
}
...
bool Fits2D::writeFits(Mat img, ImgBitDepth imgType, string fileName, string compression, string imObsType)
{
    ...
    kDATE = TimeDate::IsoExtendedStringNow();
    ...
    switch (imgType) {
        ...
        case 0: {
            ...
            if (tab == NULL) {
                ...
                mLogger->error("Fail to allocate unsigned char** array (NULL).");
                return false;
        ...
        case 1: {
            ...
            if (tab == NULL) {
                ...
                mLogger->error("Fail to allocate char** array (NULL).");
                return false;
        ...
        case 2 : {
            ...
            if (tab == NULL) {
                ...
                mLogger->error("Fail to allocate unsigned short** array (NULL).");
                return false;
        ...
        case 3 : {
            ...
            if (tab == NULL) {
                ...
                mLogger->error("Fail to allocate short** array (NULL).");
                return false;
        ...
        case 4 : {
            ...
            if (tab == NULL) {
                ...
                mLogger->error("Fail to allocate float** array (NULL).");
                return false;
            }
...
void Fits2D::printerror(int status, string errorMsg)
{
    ...
    if (status) {
        ...
        mLogger->error("CFITSIO ERROR : {} -> {}", status, str);
